...
class Ui_First(object):
    ...
    def setupUi(self, First):
        ...
        self.gridLayout.addWidget(self.AD_path_button, 3, 3, 1, 1)
        self.next_Button = QtWidgets.QPushButton(First)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.next_Button.setFont(font)
        self.next_Button.setObjectName("next_Button")
        self.gridLayout.addWidget(self.next_Button, 4, 1, 1, 1)
        self.Exit_Button = QtWidgets.QPushButton(First)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.Exit_Button.setFont(font)
        self.Exit_Button.setObjectName("Exit_Button")
        self.gridLayout.addWidget(self.Exit_Button, 4, 2, 1, 2)
        self.ch_name.raise_()
        self.ad_name.raise_()
    ...
    def retranslateUi(self, First):
        ...
        self.api_name.setText(_translate("First", "INDUCED FIT DOCKING"))

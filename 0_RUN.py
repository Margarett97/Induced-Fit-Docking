...
##
##if chain_del=='':
##  subprocess.run([chimera_path, "--nogui", "--script","1a_select_chain.py"],shell=True)
##else:
##  subprocess.run([chimera_path, "--nogui", "--script","1_select_chain.py"],shell=True)
##
##subprocess.run(["py","2_chain.py"],shell=True)
##
